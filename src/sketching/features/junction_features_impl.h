...
Vec2 stepaway_tangent(const Stroke& s1, const bool s1_head, const Float stepaway_amount);
...
struct ReverseFeature : JunctionFeature {
  ...
  void human_readable(span<Float> v) const override { feature_.human_readable(v); }
...
struct AbsCenterlineDistance final : JunctionFeature {
  ...
  std::string description() const final { return "Absolute centerline connection dist"; }
};
...
struct AbsEnvelopeDistance final : JunctionFeature {
  ...
  std::string description() const final { return "Absolute envelope connection dist"; }
};
...
struct AbsPenWidth1 final : JunctionFeature {
  ...
  std::string description() const final { return "Absolute pen width of first stroke"; }
};

struct AbsPenWidth2 final : ReverseFeature<AbsPenWidth1> {
  std::string description() const final { return "Absolute pen width of second stroke"; }
};
...
struct AbsWidth1 final : JunctionFeature {
  ...
  std::string description() const final { return "Absolute width at 1st point"; }
};

struct AbsWidth2 final : ReverseFeature<AbsWidth1> {
  std::string description() const final { return "Absolute width at 2nd point"; }
};
...
struct AbsProjectionDist1 final : JunctionFeature {
  ...
  std::string description() const final { return "Abs projection distance of 1st endp"; }
};

struct AbsProjectionDist2 final : ReverseFeature<AbsProjectionDist1> {
  std::string description() const final { return "Abs projection distance of 2nd endp"; }
};
...
struct AbsProjectionToClosestEndp2 final : ReverseFeature<AbsProjectionToClosestEndp1> {
  std::string description() const final {
...
struct EnvelopeDistance final : JunctionFeature {
  ...
  Float operator()(const Stroke& s1, Float arclen1, size_t idx1, const Stroke& s2,
                   Float arclen2, size_t idx2) const final;

  std::string description() const final {
    return fmt::format("Envelope dist divided by {}",
...
struct ProjectionOverConnection2 final : ReverseFeature<ProjectionOverConnection1> {
  std::string description() const final {
    return "Dist to projection divided by conn dist (2)";
  }
};

struct ProjectionOverConnectionMin final : MinFeature<ProjectionOverConnection1> {
  std::string description() const final {
    return "Dist to projection divided by conn dist (min)";
  }
};

struct ProjectionOverConnectionMax final : MaxFeature<ProjectionOverConnection1> {
  std::string description() const final {
...
/**
 * Return the shortest distance from the connecting point to any other stroke, divided
 * by the connection distance.
 */
...
/**
 * Return the shortest distance from the connected-to point to any other stroke, divided
 * by the connection distance.
 */
struct ClosestAnyOverConnection2 final : ReverseFeature<ClosestAnyOverConnection1> {
  std::string description() const final {
    return "Dist to closest stroke divided by conn dist (2)";
  }
};

struct ClosestAnyOverConnectionMin final : MinFeature<ClosestAnyOverConnection1> {
  std::string description() const final {
    return "Dist to closest stroke divided by conn dist (min)";
  }
};

struct ClosestAnyOverConnectionMax final : MaxFeature<ClosestAnyOverConnection1> {
  std::string description() const final {
...
struct ClosestAnyOtherOverConnection1 final : JunctionFeature {
  ...
  std::string description() const final {
    return fmt::format("Dist to closest any other {}stroke divided by conn dist (1)",
                       limit_to_visible_ ? "visible " : "");
  }
...
struct ClosestAnyOtherOverConnection2 final
  ...
  std::string description() const final {
    return fmt::format("Dist to closest any other {}stroke divided by conn dist (2)",
                       limit_to_visible_ ? "visible " : "");
  }
...
struct ClosestAnyOtherOverConnectionMin final
  ...
  std::string description() const final {
    return fmt::format("Dist to closest any other {}stroke divided by conn dist (min)",
                       limit_to_visible_ ? "visible " : "");
  }
...
struct ClosestAnyOtherOverConnectionMax final
  ...
  std::string description() const final {
    return fmt::format("Dist to closest any other {}stroke divided by conn dist (max)",
                       limit_to_visible_ ? "visible " : "");
  }
...
struct StepawayOverConnection1 final : JunctionFeature {
  ...
  std::string description() const final {
    if (factor_ == 1.0) {
      ...
      return fmt::format("Dist when stepping away ({:.0f}x) divided by conn dist (1)",
                         factor_);
    }
    return fmt::format("Dist when stepping away ({}x) divided by conn dist (1)", factor_);
  }
...
struct NearestEndpointOverStepaway1 final : JunctionFeature {
  ...
  std::string description() const final {
    return "Dist from stepaway proj to nearest endp divided by dist when stepping away "
           "(1)";
  }
};

struct NearestEndpointOverStepaway2 final : ReverseFeature<NearestEndpointOverStepaway1> {
  std::string description() const final {
    return "Dist from stepaway proj to nearest endp divided by dist when stepping away "
           "(2)";
  }
...
struct NearestEndpointOverStepawayMin final : MinFeature<NearestEndpointOverStepaway1> {
  std::string description() const final {
    return "Dist from stepaway proj to nearest endp divided by dist when stepping away "
           "(min)";
  }
...
struct NearestEndpointOverStepawayMax final : MaxFeature<NearestEndpointOverStepaway1> {
  std::string description() const final {
    return "Dist from stepaway proj to nearest endp divided by dist when stepping away "
           "(max)";
  }
...
struct TangentAngle : JunctionFeature {
  ...
  const Eigen::Matrix<Float, Eigen::Dynamic, 4>& tangents() const { return m_tangents; }
...
/**
 * Return the angle between the endpoint tangent of the first stroke and the point on the
 * other stroke.
 */
...
/**
 * Return the angle between the endpoint tangent of the second stroke and the point on the
 * other stroke.
 */
...
struct InteriorTangentAngle final : JunctionFeature {
  ...
  /// For testing purposes only.  They are only valid for fits already stored in fits_.
...
private:
  ...
  /// Index 0 holds a temporary, so that we can always return a reference in smooth_fit.
...
struct ClosestDistanceOnExtension2 final : ReverseFeature<ClosestDistanceOnExtension1> {
  std::string description() const final {
    return "Closest dist on extension divided by conn dist (2)";
  }
};

struct ClosestDistanceOnExtensionMin final : MinFeature<ClosestDistanceOnExtension1> {
  std::string description() const final {
    return "Closest dist on extension divided by conn dist (min)";
  }
};

struct ClosestDistanceOnExtensionMax final : MaxFeature<ClosestDistanceOnExtension1> {
  std::string description() const final {
...
struct Busyness1 final : JunctionFeature {
  ...
  std::string description() const final { return "Busyness at connecting point"; }
...
struct Busyness2 final : ReverseFeature<Busyness1> {
  ...
  std::string description() const final { return "Busyness at connected-to point"; }
};
...
struct PenWidth1 final : JunctionFeature {
  ...
  std::string description() const final { return "Width of stroke 1 relative to avg"; }
...
struct PenWidth2 final : ReverseFeature<PenWidth1> {
  std::string description() const final { return "Width of stroke 2 relative to avg"; }
};
...
/**
 * Return the distance from the connecting point to the closest endpoint along the stroke
 * being connected to, as a proportion of the total length of the stroke.
 */
struct ConnectedDistanceToEndpoint final : JunctionFeature {
  ...
  std::string description() const override { return "Connected-to location as ratio"; }
...
/**
 * Return the distance from the closest point to the closest endpoint along the stroke
 * being connected to, as a proportion of the total length of the stroke.
 */
...
struct ProjectionToEndpointRatio2 final : ReverseFeature<ProjectionToEndpointRatio1> {
  std::string description() const final {
    return "Projection location of 2nd endpoint as ratio";
  }
};

struct ProjectionToEndpointRatioMin final : MinFeature<ProjectionToEndpointRatio1> {
  std::string description() const final {
    return "Projection location of endpoints as ratio (min)";
  }
};

struct ProjectionToEndpointRatioMax final : MaxFeature<ProjectionToEndpointRatio1> {
  std::string description() const final {
...
struct DrawingOrderUnsignedDiff final : JunctionFeature {
  ...
  std::string description() const final { return "Drawing order unsigned difference"; }
};
